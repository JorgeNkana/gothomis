...
class CreateTblLabourReferrals extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_labour_referrals', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->string('reason');
            $table->integer('type',false,true)->length(1);
            $table->date('date');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('tbl_labour_referrals');
    }
}