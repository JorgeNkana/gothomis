...
class TblReattendanceRegisters extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
		Schema::create('tbl_reattendance_registers', function (Blueprint $table) {
             $table->increments('id');
    ...
    {
        Schema::dropIfExists('tbl_reattendance_registers');
    }
}