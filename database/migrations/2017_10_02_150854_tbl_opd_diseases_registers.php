...
class TblOpdDiseasesRegisters extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
		Schema::create('tbl_opd_diseases_registers', function (Blueprint $table) {
            $table->increments('id');
			$table->integer('facility_id')->unsigned();
			$table->date('date');				
			$table->Integer('opd_mtuha_diagnosis_id')->length(10)->unsigned()->nullable();		
            ...
            $table->foreign('opd_mtuha_diagnosis_id')->references('id')->on('tbl_opd_mtuha_diagnoses');
			$table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('tbl_opd_diseases_registers');
    }
}