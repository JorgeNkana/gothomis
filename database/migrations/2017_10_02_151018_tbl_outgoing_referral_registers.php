...
class TblOutgoingReferralRegisters extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
		Schema::create('tbl_outgoing_referral_registers', function (Blueprint $table) {
           $table->increments('id');
    ...
    {
        Schema::dropIfExists('tbl_outgoing_referral_registers');
    }
}