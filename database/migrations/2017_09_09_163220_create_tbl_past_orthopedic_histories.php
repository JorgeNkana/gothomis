...
class CreateTblPastOrthopedicHistories extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_past_orthopedic_histories', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('tbl_past_orthopedic_histories');
    }
}