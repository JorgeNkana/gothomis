/**
 * Created by Japhari on 2017-08-23.
 */

(function() {
    angular.module('authApp').controller('diabeticClinicController', diabeticClinicController);
    function diabeticClinicController($scope, $state, $http, $rootScope, $uibModal, $mdDialog) {
        ...
        $http.post('/api/diabeticOngoing', {
            "facility_id": facility_id
        }).then(function(data) {
            $scope.diabOngoing = data.data;
        });
        $http.post('/api/getDiabeticPatientsFromDoctor', {
            "facility_id": facility_id
        }).then(function(data) {
