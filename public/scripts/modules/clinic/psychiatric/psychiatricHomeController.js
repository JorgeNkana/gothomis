...
(function() {
    'use strict';
    angular.module('authApp').controller('psychiatricHomeController', psychiatricHomeController);

    function psychiatricHomeController($scope, $state, $http, $rootScope, $uibModal,$mdDialog) {
        var facility_id = $rootScope.currentUser.facility_id;
        var user_id = $rootScope.currentUser.id;
        angular.element(document).ready(function() {
            $http.post('/api/incomingPsychPatients', {
        ...
        $scope.checkAttendance = function(patient){
            ...
            $http.post('/api/checkPatientAttendance',{patient_id:patient.patient_id,
                ...
                if(data.data == 1){
                    ...
                    $scope.getPsychDataModal(patient);
                }
            });
        }
        ...
        $scope.getPsychDataModal = function(patient) {
...
//posting from history and examinations
                ...
                templateUrl: '/views/modules/clinic/psychiatric/psych.html',
                parent: angular.element(document.body),
                clickOutsideToClose: false,
                fullscreen: true,
            });
