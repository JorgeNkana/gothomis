...
(function() {
    ...
    function opdQueueController($scope, $state, $http, $rootScope, $uibModal, $mdDialog,Helper) {
...
$http.get('/api/getUsermenu/'+user_id).then(function(cardTitle){
 ...
 $scope.saveChiefComplain=function(complain,patient){
     if (complain== undefined){
         ...
         var records=[];
         records.push({client_id:patient.patient_id,mass_casualty:complain.mass_casualty,complaint:complain.chief_complaint,dead_on_arrival:complain.dead_on_arrival,user_id:user_id,facility_id:facility_id});
         $http.post('/api/save-chief-complaint',records).then(function (response) {
                 ...
                 //$scope.loadHistory(patient.patient_id);
                $('#chief_complaint').val('');
...
$http.get('/api/getSpecialClinics').then(function(data) {
 ...
 $scope.saveAccidentLocation=function(location,patient){
     if (location== undefined){
         ...
         var records=[];
         records.push({client_id:patient.patient_id,
...
var vall=$('#general_examination').val();
     ...
     if (vall==undefined ||vall==undefined=="") {
         ...
         $('#gu_rectal_examination').val("");
            ...
            $scope.showDiagnosisTrauma = function(search) {
            ...
            $scope.diagnosisTempTrauma = [];

            $scope.addConf1 = function(item,client,type) {

                        $scope.diagnosisTempTrauma.push({
                            "user_id":user_id,
                            "facility_id":facility_id,
            ...
            $scope.removeFromSelection1 = function(item, objectdata) {
