...
{	
    ...
    protected $table = "tbl_trauma_lab_results";

    protected $guarded = ["id"];
    protected $hidden  = array('pivot');
	
	public static $rules = [
        "client_id"       => "required:tbl_trauma_lab_results",
        "concept_value"   => "required:tbl_trauma_lab_results",
    ];
    ...
    public static function isDuplicate($new, $id = 0){
		$records = LabResult::where("id", "<>", $id)->get();
    ...
    public static function getSurvey($client_id){
        ...
        foreach($sub_sections as $section){
			$entries = LabResult::where("concept_id","=",$section->id)
