<?php 
    if (!defined('TOKEN_END_POINT'))
		define('TOKEN_END_POINT','http://196.13.105.15/nhifservice/Token');
	 
    if (!defined('SERVICE_END_POINT'))
		define('SERVICE_END_POINT','http://196.13.105.15/nhifservice/breeze/');
	 
    if (!defined('AUTHORIZATION_TOKEN_END_POINT'))
		define('AUTHORIZATION_TOKEN_END_POINT','http://196.13.105.15/nhifservice/Token');
     
    if (!defined('AUTHORIZATION_SERVICE_BASE_URL'))
		define('AUTHORIZATION_SERVICE_BASE_URL','http://196.13.105.15/nhifservice/breeze/'); 
     
    if (!defined('CLIENT_PHOTO_SERVICE'))
		define('CLIENT_PHOTO_SERVICE','http://196.13.105.15/Portal/breeze/Verification/GetImage?CardNo='); 
	
	 if (!defined('CLAIMS_RECONCILIATION'))
		define('CLAIMS_RECONCILIATION','http://196.13.105.15/claimsServer/api/v1/claims/'); 
    
     
    if (!defined('CLAIMS_TOKEN_END_POINT'))
		define('CLAIMS_TOKEN_END_POINT','http://196.13.105.15/claimsserver/Token');
     
    if (!defined('CLAIMS_SERVICE_BASE_URL'))
		define('CLAIMS_SERVICE_BASE_URL','http://196.13.105.15/claimsserver/api/v1/');
