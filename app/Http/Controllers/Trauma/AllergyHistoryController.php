...
use App\Model\Trauma\AllergyHistory;
use DB;
...
class AllergyHistoryController extends Controller
{
	...
	*/
...

    {
        ...
        return AllergyHistory::getSurvey($request->client_id);
