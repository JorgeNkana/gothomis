...
use App\Model\Trauma\Intervention;
use DB;
...
class InterventionController extends Controller
{
	...
	*/
...

    {
        ...
        return Intervention::getSurvey($request->client_id);
