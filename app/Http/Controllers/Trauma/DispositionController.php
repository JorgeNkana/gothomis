...
use App\Model\Trauma\Disposition;
use DB;
...
class DispositionController extends Controller
{
	...
	*/
...

    {
        ...
        return Disposition::getSurvey($request->client_id);
