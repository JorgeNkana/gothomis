...
use App\Model\Trauma\ImagingResult;
use DB;
...
class ImagingResultController extends Controller
{
	...
	*/
...

    {
        ...
        return ImagingResult::getSurvey($request->client_id);
