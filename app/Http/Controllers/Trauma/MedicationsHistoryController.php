...
use App\Model\Trauma\MedicationsHistory;
use DB;

class MedicationsHistoryController extends Controller
{
    /*
	private $model;
	...
	public __construct()
	{
		...
		$this->model = new MedicationsHistory();
	...
	*/
...

    {
        ...
        return MedicationsHistory::getSurvey($request->client_id);
