...
use App\Model\Trauma\Assessment;
use DB;
...
class AssessmentController extends Controller
{
	...
	*/
...

    {
        ...
        return Assessment::getSurvey($request->client_id);
