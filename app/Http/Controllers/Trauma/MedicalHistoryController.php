...
use App\Model\Trauma\MedicalHistory;
use DB;
...
class MedicalHistoryController extends Controller
{
	...
	*/
...

    {
        ...
        return MedicalHistory::getSurvey($request->client_id);
