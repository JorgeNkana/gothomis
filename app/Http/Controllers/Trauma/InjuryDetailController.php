...
use App\Model\Trauma\InjuryDetail;
use DB;

class InjuryDetailController extends Controller
{
    /*
	private $model;
	...
	*/
...

    {
        ...
        return InjuryDetail::getSurvey($request->client_id);
