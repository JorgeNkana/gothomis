...
use App\Model\Trauma\LabResult;
use DB;
...
class LabResultController extends Controller
{
	...
	*/
...

    {
        ...
        return LabResult::getSurvey($request->client_id);
