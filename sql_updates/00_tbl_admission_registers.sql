...
--
-- Host: localhost    Database: gothomis_v3
-- ------------------------------------------------------
...
--
-- Table structure for table `tbl_admission_registers`
--
...
CREATE TABLE IF NOT EXISTS `tbl_admission_registers` (
  ...
  PRIMARY KEY (`id`),
  KEY `tbl_admission_registers_facility_id_foreign` (`facility_id`),
  CONSTRAINT `tbl_admission_registers_facility_id_foreign` FOREIGN KEY (`facility_id`) REFERENCES `tbl_facilities` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_admission_registers`
--

LOCK TABLES `tbl_admission_registers` WRITE;
/*!40000 ALTER TABLE `tbl_admission_registers` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_admission_registers` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-11-27 20:28:06