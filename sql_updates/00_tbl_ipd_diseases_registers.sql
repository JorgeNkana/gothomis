...
--
-- Table structure for table `tbl_ipd_diseases_registers`
--
...
CREATE TABLE IF NOT EXISTS `tbl_ipd_diseases_registers` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `facility_id` int(10) unsigned NOT NULL,
  `date` date NOT NULL,
  `ipd_mtuha_diagnosis_id` int(10) unsigned DEFAULT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `tbl_ipd_diseases_registers_facility_id_foreign` (`facility_id`),
  KEY `tbl_ipd_diseases_registers_ipd_mtuha_diagnosis_id_foreign` (`ipd_mtuha_diagnosis_id`),
  CONSTRAINT `tbl_ipd_diseases_registers_facility_id_foreign` FOREIGN KEY (`facility_id`) REFERENCES `tbl_facilities` (`id`),
  CONSTRAINT `tbl_ipd_diseases_registers_ipd_mtuha_diagnosis_id_foreign` FOREIGN KEY (`ipd_mtuha_diagnosis_id`) REFERENCES `tbl_ipd_mtuha_diagnoses` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_ipd_diseases_registers`
--

LOCK TABLES `tbl_ipd_diseases_registers` WRITE;
/*!40000 ALTER TABLE `tbl_ipd_diseases_registers` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_ipd_diseases_registers` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-11-20 15:16:06