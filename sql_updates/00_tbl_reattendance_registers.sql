...
--
-- Table structure for table `tbl_reattendance_registers`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `tbl_reattendance_registers` (
  ...
  PRIMARY KEY (`id`),
  KEY `tbl_reattendance_registers_facility_id_foreign` (`facility_id`),
  CONSTRAINT `tbl_reattendance_registers_facility_id_foreign` FOREIGN KEY (`facility_id`) REFERENCES `tbl_facilities` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_reattendance_registers`
--

LOCK TABLES `tbl_reattendance_registers` WRITE;
/*!40000 ALTER TABLE `tbl_reattendance_registers` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_reattendance_registers` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-11-20 15:21:56