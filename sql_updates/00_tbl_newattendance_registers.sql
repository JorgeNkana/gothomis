...
--
-- Table structure for table `tbl_newattendance_registers`
--
...
CREATE TABLE IF NOT EXISTS `tbl_newattendance_registers` (
  ...
  PRIMARY KEY (`id`),
  KEY `tbl_newattendance_registers_facility_id_foreign` (`facility_id`),
  CONSTRAINT `tbl_newattendance_registers_facility_id_foreign` FOREIGN KEY (`facility_id`) REFERENCES `tbl_facilities` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_newattendance_registers`
--


LOCK TABLES `tbl_newattendance_registers` WRITE;
/*!40000 ALTER TABLE `tbl_newattendance_registers` DISABLE KEYS */;

/*!40000 ALTER TABLE `tbl_newattendance_registers` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-11-20 15:21:39